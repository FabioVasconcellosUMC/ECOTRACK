<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-6">
      ...
      <button
        @click="abrirModal"
        class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg flex items-center gap-2"
      >
        + Nova Empresa
      </button>
    </div>
      ...
      <table class="w-full text-sm text-left text-gray-300">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4">
              <span :class="tipoBadge(empresa.tipo)" class="px-2 py-1 rounded-full text-xs font-medium">
                {{ empresa.tipo }}
              </span>
            </td>
            <td class="px-6 py-4">{{ empresa.email }}</td>
            <td class="px-6 py-4">
              <span :class="empresa.ativa ? 'text-green-400' : 'text-red-400'">
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="flex gap-2">
              <input
                ...
                class="flex-1 bg-gray-700 text-white rounded-lg px-3 py-2 text-sm"
              />
              <button
                @click="consultarCnpj"
                class="bg-teal-600 hover:bg-teal-700 text-white px-3 py-2 rounded-lg text-sm"
              >
                Buscar
              </button>
            </div>
          ...
          <div>
            ...
            <input
              ...
              class="w-full bg-gray-700 text-white rounded-lg px-3 py-2 text-sm"
            />
          </div>
